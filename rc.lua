...
-- Take a screenshot
    awful.key({}, "Print", function() awful.spawn("flameshot full -p ~/Pictures/Screenshots") end,
        { description = "Take a screenshot of all monitors", group = "hotkeys" }),
    awful.key({ modkey }, "Print", function() awful.spawn("flameshot gui -p ~/Pictures/Screenshots") end,
        { description = "Take a screenshot with GUI", group = "hotkeys" }),
    ...
    awful.key({ modkey }, "KP_Begin", function()
            awful.spawn.easy_async("hass-cli state toggle light.desklamp",
                function() awesome.emit_signal('desklight::update') end)
        end,
...
awful.rules.rules = {
    ...
    },
    {
        ...
        properties = { floating = true, focus = false,
            placement = awful.placement.no_overlap + awful.placement.top_right, above = true, ontop = true }
    }
}
-- }}}
